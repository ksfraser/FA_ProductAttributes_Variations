...
class FrontAccountingVariationService extends VariationService
{
    ...
    public function __construct(VariationsDao $variationsDao, ProductAttributesDao $coreDao, DbAdapterInterface $attributesDb, DbAdapterInterface $faDb)
    {
        parent::__construct($variationsDao, $coreDao, $attributesDb);
        $this->faDb = $faDb;
    }
