...
- **Pricing Rules**: Apply fixed amount or percentage adjustments to variations based on attribute combinations
- **Bulk Operations**: Perform batch operations on multiple products (attribute assignment, price updates, status changes)

## Recent Changes

- **Pricing Rules Service**: Added support for variation-based pricing with fixed/percentage/combined adjustments
- **Bulk Operations Service**: Framework for batch operations with plugin extensibility
- **Hook Integration**: Added hooks for pricing rules application and bulk operations registration
...
- Register pricing rules and bulk operations
